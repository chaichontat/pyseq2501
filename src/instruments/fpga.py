    ...
    **Attributes**
    ...
    def __init__(self, com_port_command, com_port_response, baudrate=115200, logger=None):
        ...
        **Returns:**
        ...
        if isinstance(com_port_command, int):
            com_port_command = "COM" + str(com_port_command)
        if isinstance(com_port_response, int):
            com_port_response = "COM" + str(com_port_response)
        ...
        try:
            ...
            self.serial_port = io.TextIOWrapper(
                io.BufferedRWPair(s_response, s_command), encoding="ascii", errors="ignore"
            )
        except:
    ...
    def TDIYARM3(self, n_triggers, y_pos):
        ...
        **Parameters:**
        ...
        self.command("TDIYARM3 " + str(n_triggers) + " " + str(y_pos + self.y_offset - 10000) + " 1")
