...
<div id="nav" class="sticky inset-x-0 top-0 z-50 w-full h-16 transition duration-200 ease-in-out bg-white shadow-sm opacity-95 ring-1 ring-gray-900 ring-opacity-5">
  <div class="flex items-center h-full mx-auto gap-x-6">
    ...
    <div title="Github ↗︎" class="items-center flex-none pr-6">
      <a target="_blank" href="https://github.com/chaichontat/pyseq2501-web" rel="noopener" class="normal-case">
...
<style lang="postcss">
  .active {
    @apply border-b-gray-800 text-gray-900;
  }
</style>
