...
>
  <div class="mx-auto space-x-1 navbar max-w-none">
    ...
    <div class="flex-1" />
    <div class="tabs">
      <a class="tab tab-lg tab-bordered" on:click={() => (tab = "manual")} class:tab-active={tab === "manual"}>Manual</a>
      <a class="tab tab-lg tab-bordered" on:click={() => (tab = "automatic")} class:tab-active={tab === "automatic"}>Automatic</a>
    </div>
    ...
    <div title="Change Theme" class="dropdown dropdown-end">
      <div tabindex="0" class="m-1 normal-case btn-ghost btn pr-0">
        ...
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1792 1792" class="inline-block w-4 h-4 ml-1 fill-current"
          ><path
